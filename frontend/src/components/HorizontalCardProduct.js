...
//                          </div>
//                          <button className=' text-sm bg-red-500 hover:bg-red-700 text-white px-3 py-0.5 rounded-full w-full' onClick={(e)=>handleAddToCart(e,product?._id)}>Add to Cart</button>
//                       </div>
//                   </Link>
//               )
//           })
