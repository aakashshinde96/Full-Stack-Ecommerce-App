...
// import displayINRCurrency from '../helpers/DisplayCurrancy'
...
//                 <h2 className='text-2xl lg:text-4xl font-medium h-6 w-full lg:h-8 bg-slate-200'></h2>
//                 <p className='capitalize text-slate-400  bg-slate-200 min-w-[100px] animate-pulse h-6  w-full lg:h-8'></p>

//                 <div className='text-green-600 bg-slate-200 h-6 animate-pulse flex items-center gap-1 lg:h-8 w-full'>
...
//                 </div>
//                 <div className='flex items-center gap-3 my-2 lg:h-8 w-full'>
//                     <button className='h-6 bg-slate-200 rounded animate-pulse lg:h-8 w-full'></button>
//                     <button className='h-6 bg-slate-200 rounded animate-pulse lg:h-8 w-full'></button>
//                 </div>
//                 <div className=' w-full'>
//                   <p className='text-slate-600 font-medium my-1 h-6 bg-slate-200 rounded animate-pulse lg:h-8 w-full'></p>
...
//          {
//           data.category && (
//             <CategoryWiseProductDisplay category={data?.category} heading={"Mobiles"} />
//           )
//          }
